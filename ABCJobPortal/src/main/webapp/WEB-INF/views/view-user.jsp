<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<div id="userHomeArea" class="flex userProfile">
		...
		<div id="userProfileCard" class="flex">
			...
			<button form="adminEdit" id="editProfileBtn" class="font" onclick="window.location='<%=request.getContextPath()%>/edit-user-details'">Edit Profile</button>
	
		</div>
		
		</div>
		
		<form id="adminEdit" action="edit-user-details" method="post">
